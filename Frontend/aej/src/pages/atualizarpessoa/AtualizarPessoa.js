...
function AtualizarPessoa() {
    ...
    const atualizarPessoa = async (e) => {
        ...
        const response = await axios.put(
            ...
            {
                idcliente: idcliente, nome: nome, idade: idade, cpf: cpf, email: email, sexo: sexo, rg: rg, inscricaoestadual: estadual,
                ...
                <section className="form">
                    <form className="text-field" >
                        ...
                        <div className="btn">
                            ...
                            <button onClick={atualizarPessoa} className="btn-on">Salvar</button>
                        </div>
                    </form>
                </section>
